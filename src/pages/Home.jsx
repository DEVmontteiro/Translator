...
function Home() {
    ...
    const handleSwapLanguages = () => {
        ...
        setTargeLang(sourceLang);
        setSourceText(textTranslate);
        setTextTranslate(sourceText);
    };
                ...
                <main className="flex grow items-start justify-center px-4 py-8">
                    <div className="w-full max-w-5xl bg-white rounded-lg shadow-md overflow-hidden">
                        <div className="flex items-center justify-between p-4 border-b border-gray-200">
                            ...
                            <button className="p-2 rounded-full hover:bg-gray-100 outline-none" onClick={handleSwapLanguages}>
